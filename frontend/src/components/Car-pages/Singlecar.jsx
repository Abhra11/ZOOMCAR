              ...
              <Box margin="auto" display="flex" w="auto" h="40px">
                <Box h="60%" w="5%" marginLeft="15px">
                  <Image
                    h="80%"
                    w="70%"
                    src="https://zoomcar-assets.zoomcar.com/images/original/b04593cd90f850d14ed46ed739b0371457ef6834.png?1633947533"
                  />
                </Box>
                <Text fontSize="15px" marginLeft="2px">
                  {data.rating}
                </Text>
            ...
            <SimpleGrid gap={2} columns={{ base: 1, sm: 1, md: 1, lg: 2 }}>
              <Box h="80px">
                ...
                <Box h="auto" w="auto" marginLeft="15px">
                  <Text fontSize="sm" marginLeft="45px">
                    Janakpuri , Delhi
                  </Text>
                </Box>
              </Box>
          ...
          <Box h="auto" marginTop="30px">
            <SimpleGrid gap={6} columns={{ base: 1, sm: 1, md: 1, lg: 2 }}>
              <Box boxShadow="rgba(9, 30, 66, 0.25) 0px 4px 8px -2px, rgba(9, 30, 66, 0.08) 0px 0px 0px 1px">
                ...
                <Box marginTop="10px">
                  <Text fontSize="lg" marginLeft="20px">
                    J3HJ+XV8, Janakpuri District Center, Janakpuri, Delhi,
                    110058, India
                  </Text>
                </Box>
                <Box marginTop="10px">
                  <Text fontSize="sm" marginLeft="20px" color="blue">
              ...
              >
                ...
                <Box display="flex" h="auto">
                  ...
                  <Box marginLeft="15px">
                    ...
                    <Text fontSize="sm" fontWeight="400" color="#A8A8A8">
                      Fare is inclusive of all taxes. Kindly return the car at
                      the same fuel level as the trip start time
                    </Text>
                    <Text fontSize="md" fontWeight="400" as="u" color="#10a310">
                      See Details
                    </Text>
                  </Box>
                </Box>
          ...
          <Box h="auto">
            ...
            <Box display="flex" h="auto">
              ...
              <Box marginLeft="15px">
                ...
                <Text fontSize="md" fontWeight="400" color="#10a310">
                  RECOMMENDED FOR YOU
                </Text>
              </Box>
              <Box margin="auto">
            ...
            <Box h="auto">
              <Text marginLeft="18px" fontWeight="400" fontSize="17">
                How Trip Protection Works?
              </Text>
              <Text marginLeft="18px" fontWeight="300" fontSize="15">
