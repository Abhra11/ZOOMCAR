        ...
        <Box className="filterOne">
            ...
            <SimpleGrid gap={2} columns={{ base: 1, sm: 2, md: 3, lg: 4 }}>
              ...
              >
                <Box h="auto" marginTop="8px" cursor="pointer">
                  ...
                  />
                  <Text fontWeight="600" fontSize="13.5px" as="b">
                    Relevance
                  </Text>
                </Box>
              </Box>
              ...
              >
                <Box h="auto" marginTop="8px" cursor="pointer">
                  <GrCar
                    style={{ height: "30px", width: "25px", margin: "auto" }}
                  />
                  <Text fontWeight="600" fontSize="13.5px" as="b">
                    Car Age
                  </Text>
              ...
              >
                <Box h="auto" marginTop="8px" cursor="pointer">
                  <FaBullhorn
                    style={{ height: "30px", width: "24px", margin: "auto" }}
                  />
                  <Text fontWeight="600" fontSize="13.5px" as="b">
                    Popularity
                  </Text>
          ...
          <Box border="1px solid white" marginTop="35px" h="auto">
            <Box marginTop="5px" h="auto" display="flex">
              <Box>
                <BiCar
                  style={{ height: "35px", width: "45px", margin: "auto" }}
                />
              </Box>
              <Box>
                <Text fontWeight="600" fontSize="16.5px" as="b">
                  Include specific cars{" "}
                </Text>
                <br />
                <Text fontWeight="600" fontSize="13.5px" as="b" color="gray">
                  {" "}
                  Any specific model in mind? Find it here. We will include them
                  to search
                </Text>
              </Box>
            </Box>
            ...
            <Box marginTop="10px" display="flex">
              ...
              <Box w="85%">
                <InputGroup>
                  ...
                  <Input
                    type="tel"
                    placeholder='Type search "Hero Honda'
                    size="sm"
                  />
                </InputGroup>
              </Box>
            ...
            <Box border="1px solid white" h="20px" marginTop="5px"></Box>
          </Box>
          ...
          <Box border="1px solid white" h="100px"></Box>
        </Box>
      </Box>
    </div>
  );
