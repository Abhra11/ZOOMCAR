      ...
      <Box h={660} position="relative">
        ...
        >
          <Flex flexDirection={"column"}>
            ...
            <Center>
              <Box>
                <Heading color={"white"} margin="0" size={["md", "lg", "lg"]}>
                  Book your drive now!
                </Heading>
              </Box>
            </Center>
          ...
          <Tabs isFitted variant="enclosed" w={[360, 500, 500, 500]}>
            <Center>
              <TabList
                ...
                bg={"white"}
                mb="0.3em"
                w={[330, 470, 470, 470, 470]}
              >
                <Tab
                  h={12}
                  borderRadius="0"
                  _selected={{ border: "1px solid green" }}
                >
              ...
              <TabPanel>
                <Box marginBottom="10px" mb="0.3em">
                  <Input
                    ...
                    h={12}
                    borderRadius="0"
                    placeholder="Pick Up City, Airport, Address"
                    background={"white"}
                    w={[330, 470, 470, 470]}
                  />
                </Box>
            ...
            <Center>
              <Box>
                <Heading
                  ...
                  size={["md", "md", "md"]}
                >
                  We cover you under all the circumstances to the best journey
                </Heading>
              </Box>
            </Center>
          </Flex>
        ...
        <Tabs w={"90%"} margin="auto" bg="#383838" variant="unstyled">
          <TabList justifyContent={"space-between"}>
            <Tab
              ...
              fontWeight="bold"
            >
              <Heading size={["xs", "md"]}>ABOUT US</Heading>
            </Tab>
            <Tab
              _selected={{ borderBottom: "2px solid white" }}
              fontWeight="bold"
            >
              <Heading size={["xs", "md"]}>BLOGS</Heading>
            </Tab>
            <Tab
              _selected={{ borderBottom: "2px solid white" }}
              fontWeight="bold"
            >
              <Heading size={["xs", "md"]}>CAREERS</Heading>
            </Tab>
            <Tab
              _selected={{ borderBottom: "2px solid white" }}
              fontWeight="bold"
            >
              <Heading size={["xs", "md"]}>HELP & SUPPORT</Heading>
            </Tab>
          </TabList>
          <br />
          <TabPanels>
            <TabPanel>
              ...
              <Text>
                ...
                booking! The Zoommcar smart-app allows you to lock & unlock the
                car directly through the app!
              </Text>
              <Heading size="md">We’ve Got A Car For All Your Needs:</Heading>
              <br />
              <Text>
              ...
              <Text>
                ...
                with friends and family & much more! Car rental starts as low as
                Rs. 49/hour.
              </Text>
            </TabPanel>
            <TabPanel>
